...
function seedCatalog(): LayerCatalog {
  ...
  const layers: LayerConfig[] = [
    ...
    mk({
      ...
      style: { fillColor: "#f97316", strokeColor: "#fb923c", lineWidth: 4, pointSize: 8 },
    }),
    mk({
      name: "Site POIs",
    ...
    mk({
      name: "ATLAS-01 patrol",
      description: "Robot body + patrol polyline",
      ...
      zOrder: 70,
      coordinateSystem: "EPSG:4326",
      dataSource: "/demo/robot-path.json",
