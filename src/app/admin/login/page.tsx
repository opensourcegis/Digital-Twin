    ...
    <div className="grid min-h-[100dvh] place-items-center bg-[#0b1220] px-4">
      ...
      >
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-display text-xl text-white">TwinBench Admin</h1>
            <p className="text-xs text-slate-400">Layer management sign-in</p>
          </div>
        </div>
        ...
        <p className="mt-2 text-[10px] text-slate-500">
          Default local password: <code className="text-violet-300">twinbench</code> (override with{" "}
